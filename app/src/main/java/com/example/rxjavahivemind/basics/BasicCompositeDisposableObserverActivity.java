...
public class BasicCompositeDisposableObserverActivity extends AppCompatActivity {
     ...
     */
    private static final String TAG = BasicCompositeDisposableObserverActivity.class.getSimpleName();
