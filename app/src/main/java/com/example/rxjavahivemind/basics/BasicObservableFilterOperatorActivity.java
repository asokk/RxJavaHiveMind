...
public class BasicObservableFilterOperatorActivity extends AppCompatActivity {
     ...
     */
    private static final String TAG = BasicObservableFilterOperatorActivity.class.getSimpleName();
