...
public class BasicObservableFilterMapActivity extends AppCompatActivity {
     ...
     */
    private static final String TAG = BasicObservableFilterMapActivity.class.getSimpleName();
